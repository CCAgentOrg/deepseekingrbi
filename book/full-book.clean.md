...
| Did byelaws change before IKCON award? | (red) Unverified | Request IDRBT Governing Council minutes (RBI RTI) |
| What was the contract value? | (red) Unknown | Requires procurement records |
| Deepak Kumar's specific role in award? | (red) Circumstantial | He is Director — final approving authority for all IDRBT procurement |
| IFTAS--->IKCON move timing? | [!] LinkedIn forensic incomplete | Full ZoomInfo/LinkedIn scrape of Mahesh Jarati's career timeline |
| Other IKCON-IDRBT contracts? | (red) Unknown | Search IDRBT published tenders; GSTIN-based tracking |
...
| Byelaw amendment for vendor rates | (red) **Allegation only** | Source claim; no public document found yet |
| Rate rigging / better rates | (red) **Unverified** | Need pre/post contract pricing data |
...
- (red) The byelaw amendment itself remains unverified — requires IDRBT Governing Council minutes (which are not public)
...
| IDRBT | Registered Society | **(red) Disputed/No** | (-) |
...
| Byelaw amendment for vendor rates | (red) **Allegation only** | Source claim; no public document found yet |
| Rate rigging / better rates | (red) **Unverified** | Requires pre/post contract pricing data |
