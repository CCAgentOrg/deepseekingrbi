...
| NIPL ₹200 crore paid-up capital, incorporated 3 Apr 2020 | https://www.thecompanycheck.com/company/npci-international-payments-limited/U67190MH2020PLC339220 | 2026-07-11 |
| NPCI Section 8 for-profit conversion debate | https://www.sanskritiias.com/current-affairs/npci-from-not-for-profit-to-for-profit | 2026-07-11 |
| RBI IT Governance Master Directions (2023) | https://www.rbi.org.in/ScriptS/BS_ViewMasDirections.aspx?id=12562 | 2026-07-11 |
| RBI Fintech Department overview | https://rbi.org.in/scripts/FS_Overview.aspx?fn=2765 | 2026-07-11 |

---

# Annexure B: IDRBT Published Tenders vs. IKCON Award — Negative Evidence Analysis

**Method**: IDRBT's tender page (https://www.idrbt.ac.in/tenders/) lists all current and archived published tenders. We checked all entries on this page for any mention of `.bank.in`, domain registry, or IKCON.
...
- Facility Services
- Various academic/IT procurement

**Negative evidence confirmation**: The absence of a `.bank.in` portal tender where all other IDRBT procurement is published constitutes strong negative evidence that the contract was awarded without competitive process. If it were competitively tendered, the tender notice should have appeared on this page alongside all others.
...
| **2008** | NPCI established as Section 8 company | 10 member banks | Retail payments infrastructure |
| **2009** | EERC (Rangarajan Committee) | RBI | Recommends IDRBT shed operational services |
| **2015** | IFTAS established as Section 8 company | Banks | Takes over INFINET, SFMS, other IDRBT-built infrastructure |
| **2016** | ReBIT established as Pvt Ltd | RBI (fully owned) | Cybersecurity subsidiary |
| **2018** | RBI overrules NPCI board CEO choice | RBI → NPCI | Forced Dilip Asbe appointment; board dissent notes |
| **2019** | RBI acquires IFTAS | RBI | Clawback of IDRBT's built assets |
| **2019** | RBI divests NABARD, NHB to govt | RBI → Govt | Sheds developmental entities while consolidating tech control |
| **2020** | NPCI International (NIPL) established | NPCI | For-profit subsidiary for global payments |
| **2022-01** | RBI Fintech Department established | RBI (internal) | Subsumes DPSS fintech unit |
| **2022-03** | RBI Innovation Hub (RBIH) established | RBI (Section 8) | External fintech innovation entity |
| **2024-01** | K. Nikhila appointed IDRBT Director | RBI → IDRBT | 3-month placeholder appointment |
| **2024-02** | Ajay Kumar Choudhary appointed NPCI Chairman | RBI → NPCI | Former RBI ED now heading NPCI board |
| **2024-05** | Deepak Kumar appointed IDRBT Director | RBI → IDRBT | Former RBI ED (IT) now heads the entity he oversaw |
| **2024** | Deepak Kumar simultaneously on NPCI, IFTAS, ReBIT, RBIH, IOB boards | All entities | Revolving door in full operation |
| **2025-2026** | `.bank.in` portal operational with critical vulnerabilities | IDRBT/IKCON | No security audit; 33+ unauthenticated endpoints |
| **2026-06** | Medianama publishes security vulnerability story | Public | Governance debacle enters public record |
| **2026-06** | CashlessConsumer publishes .bank.in investigation | Public | Documents no-tender award to IKCON |

---

# Annexure D: Key Legal Framework Analysis
...
| Companies Act, 2013 | Not applicable to IDRBT; ReBIT and NIPL registered under this |
| Section 8 Companies Act, 2013 | Legal form for IFTAS, RBIH, NPCI (not-for-profit) |
| General Financial Rules (GFR) | Not applicable to societies; only govt departments |
| CAG's audit mandate | National Financial Reporting Authority (NFRA) doesn't cover private/society entities |
...
| ReBIT | ❌ Pvt Ltd company | Presumed |
...
*Compiled: 2026-07-11. Status: Working annexures document. Cross-reference with main report for footnoted citations.*